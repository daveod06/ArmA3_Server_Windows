...
SET CollectionModsFile=\\infc2_file\fileserv_data01\users\dj005112\Documents\server\vietnam_mods.txt
SET ServerArgsFile=\\infc2_file\fileserv_data01\users\dj005112\Documents\server\headless_args1.txt
